...
class NumberPublisherNode(LifecycleNode):
    ...
    # Create ROS2 communications, connect HW ...
    ...
    # Activate the node, enable HW ...
    def on_activate(self, previous_state: LifecycleState):
        self.get_logger().info("IN on_activate")
        return super().on_activate(previous_state)
        
    # Deactivate the node, disable HW ...
    def on_deactivate(self, previous_state: LifecycleState):
        self.get_logger().info("IN on_deactivate")
        return super().on_deactivate(previous_state)

    # Clean up ROS2 communications, disconnect HW ...
    ...
    # Shutdown the node, disconnect HW ...
